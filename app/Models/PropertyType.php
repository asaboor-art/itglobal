...
class PropertyType extends BaseModel
{
    ...
    public $class_name = 'App\Models\PropertyType';
    ...
    public static function boot()
    {
        ...
        static::addGlobalScope('active_property_types', function (Builder $builder) {
            $user = Auth::user();
            if(isset($user) && !$user->hasRole('admin')){
                $builder->where('property_types.is_delete', '=', 0);
            }else{
                $builder->where('property_types.is_delete', '=', 0)->where('property_types.is_active','=',1);
            }
