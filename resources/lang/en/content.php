...
return [
    ...
    'services' => [
        ...
        'services' => [
            [
                'heading' => 'Ceramic Coating Protection',
                'description' => "In Calgary, Drip Detailing is the top supplier of ceramic coating finishes. We provide a comprehensive selection of ceramic coatings made to shield your car from the elements and maintain its aesthetic appeal.",
                'link' => 'service',
                'slug' => str_replace(' ','-',strtolower('Ceramic Coating Protection')),
                'image' => 'ser1.png',
            ],
            [
                'heading' => 'Polish & Paint Correction Page',
                ...
                'link' => 'service',
                'slug' => str_replace(' ','-',strtolower('Polish & Paint Correction Page')),
                'image' => 'ser2.png',
            ],
            [
            ...
            [
                'heading' => 'Paint Protection Film Page',
                ...
                'link' => 'service',
                'slug' => str_replace(' ','-',strtolower('Paint Protection Film Page')),
                'image' => 'ser4.png',
            ]
        ],
        'ceramic-coating-protection' => [
            'heading' => '<span>Ceramic Coating</span> Protection',
            'description' => "Your car's exterior is given additional protection by the ceramic coating process, which also helps it look like new with less upkeep.",
            'sections' => [
                [
        ...
        'polish-&-paint-correction-page' => [
            ...
            'sections' => [
                ...
                'things-sec' => [
                    ...
                    'features' => ['Buff & Wax','Paint Enhancement','Paint Correction']
                ]
            ]
        ],
    ...
    'container-sec' => [
        ...
        [
            'heading' => 'Detailing',
            'description' => "Polishing and paint correction are two related processes used to restore and improve the appearance of a vehicle's paint. Polishing is the process of removing the outermost layer of paint, which may have become dull or scratched over time, to reveal a smoother and more reflective surface.
            ...
            <p>Both polishing and paint correction require careful attention to detail and the use of specialized tools and equipment. The goal is to create a smooth and uniform surface that reflects light evenly, resulting in a deep and lustrous finish.
            Polishing and paint correction can offer a number of benefits for a vehicle's appearance, including improved gloss and shine, increased depth and clarity of color, and a smoother overall texture. It can also help to remove minor imperfections that might otherwise detract from the vehicle's overall appearance.
            Overall, polishing and paint correction are essential steps in maintaining the appearance and value of a vehicle's exterior. By removing imperfections and restoring the paint's original shine and luster, these processes can help to keep a vehicle looking its best for years to come.
            ",
    ...
    'why-sec' => [
        'heading'   => '<span>Why</span> Calgarydetailing.ca',
