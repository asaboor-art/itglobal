...
<head>
    ...
    <meta property="og:description"
        content="Check out my new idea shared on I-launched. Join now and find Ideas to keep your business' ideas pipeline growing." />
    <meta property="og:url" content="{{ env('APP_URL') }}" />
    <meta property="og:site_name" content="{{ env('APP_NAME') }}" />
    <meta name="image" property="og:image" content="{{ asset('images/nav-logo-200x200.png') }}" />
...
<body>
    <div class="main-section">
        ...
        @if (\Route::currentRouteName() == 'home' || \Route::currentRouteName() == 'company-idea')
    ...
    <script>
        $("#faqs").on("hide.bs.collapse show.bs.collapse", e => {
            $(e.target)
                .prev()
                .find("i:last-child")
