...
<section class="about-banner-sec">
    ...
    <section class="roller-man-sec">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            <img src="images/roller-man.png" alt="image" class="img-fluid">
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="roller-man-content">
              ...
              <form>
                ...
                <textarea cols="1" rows="1" placeholder="Message" class="form-control"></textarea>
                <h6>CAPTCHA</h6>
                <img src="images/captcha.png" alt="image" class="img-fluid">
                <div class="form-btn">
